...
module.exports = function (moduleDef:any, options:any, callback:Function):void {
    ...
    var clientSourcePath:string = path.join(options.appRootAbsolute, 'node_modules', moduleDef.name, 'client/styles');
    var clientDestinationRoot:string = path.join(options.appRootAbsolute, 'assets/styles/dependencies');
