...
module.exports = function (moduleDef, options, callback) {
    ...
    var clientSourcePath = path.join(options.appRootAbsolute, 'node_modules', moduleDef.name, 'client/sounds');
    var clientDestinationRoot = path.join(options.appRootAbsolute, 'assets/sounds/dependencies');
